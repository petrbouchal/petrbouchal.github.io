...
library(CzechData)
library(mapview)
okrpng <- here::here("static", "/w_okrsky.png")
...
```{r}
zelpng <- here::here("static", "/w_zeleznice.png")

zelw <- zeleznice() %>% mapview()
mapshot(wgt@map, file = zelpng,
        remove_controls = NULL, vheight = 600, vwidth = 1000)

knitr::include_graphics(zelpng)
```

...
subtitle: "a využít je v reprodukovatelném výzkumu"
author: "Petr Bouchal"
date: "pro PSSAÚ `r ptrr::format_date_human(as.Date("2020-07-03"))` [zatím neprezentováno]"
output:
...
<img src="krugman.png" alt="drawing" width="700"/>
...
## Rozpočty + výsledovky + rozvahy 2010-20

###  = kde berou peníze, jak je utrácejí, jak hospodaří, co vlastní

### + další specifické údaje (dotace, financování deficitů...)

## Ministerstva, příspěvkovky, obce, městské části
...
## open data: velké množství, relativně složité využití, holá data s kódy, třeba rozumět číselníkům
...
### celý postup zaznamenán v kódu > jde snadno zopakovat

--

### [dokumentace vysvětlující i strukturu a obsah dat](https://petrbouchal.github.io/statnipokladna/articles/how-the-data-works.html)
...
<img src="sp.png" alt="drawing" width="250"/>
...
## ČSÚ část dat poskytuje formou otevřených dat

### = konzistentní, strojově zpracovatelné soubory

### + katalog

### cca 600 datových sad

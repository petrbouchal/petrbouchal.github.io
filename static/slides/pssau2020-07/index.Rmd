...
```{r, message=F, echo=F, results="html"}
...
prg_hranice <- CzechData::load_RUIAN_settlement(pragr::prg_kod)
```
...
prg_hranice <- CzechData::load_RUIAN_settlement(pragr::prg_kod)
katastr <- CzechData::load_cadastral_territory(CzechData::katastralni_uzemi[CzechData::katastralni_uzemi$nazev == "Nusle",]$kod)
```
